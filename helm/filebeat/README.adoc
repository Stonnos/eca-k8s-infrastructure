...
output.elasticsearch:
  # Хост и порт victorialogs для сохранения логов
...
|7.6.1
|Версия образа
|*filebeat.victorialogs.host*
|elasticsearch
|Хост victorialogs для хранения логов
|*filebeat.victorialogs.port*
|9428
|Порт victorialogs для хранения логов
|===
